    ...
    <div className="flex flex-col flex-1 justify-between mt-5 bg-gray-6 h-[calc(100vh-3.5rem)]">
      <div className="mx-auto w-full max-w-8xl grow flex flex-col-reverse lg:flex-row">
        <div className="flex-1 xl:flex">
          <div className="px-4 pt-6 sm:px-6 border border-gray-6 bg-gray-6 lg:pl-8 xl:flex-1 xl:pl-6 max-h-[calc(100vh-5rem)] overflow-y-scroll no-scrollbar">
            <PdfRenderer />
          </div>
        </div>
        <div className="shrink-0 lg:border-2 px-5 lg:border-gray-6 w-full lg:w-96 lg:flex-[0.65] pb-4 lg:pb-0 lg:p-4 max-h-screen bg-white">
